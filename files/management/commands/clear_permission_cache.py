...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if options["all"]:
            ...
            self.stdout.write(self.style.ERROR("Please specify --all, --pattern, or --media-uid"))
    ...
    def clear_all_permission_cache(self):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f"Total entries cleared: {total_cleared}"))
    ...
    def clear_cache_by_pattern(self, pattern):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"Error clearing cache with pattern {pattern}: {e}"))
    ...
    def clear_media_cache(self, media_uid, user_id=None):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"Error clearing cache for media {media_uid}: {e}"))
