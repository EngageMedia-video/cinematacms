...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if options["dry_run"]:
            ...
            existing_countries = {mc.title: mc for mc in MediaCountry.objects.only("title", "media_count")}
        ...
        for country_code, country_title in lists.video_countries:
            ...
            if options["dry_run"]:
                ...
                country_obj, created = MediaCountry.objects.get_or_create(title=country_title)
