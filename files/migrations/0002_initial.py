...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="channel",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="users.channel"
            ),
        ),
        migrations.AddField(
            model_name="media",
        ...
        migrations.AddField(
            ...
            name="license",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="files.license"
            ),
        ),
        migrations.AddField(
            model_name="media",
        ...
        migrations.AddField(
            ...
            name="media",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="encodings", to="files.media"
            ),
        ),
        migrations.AddField(
            model_name="comment",
            name="media",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="comments", to="files.media"
            ),
        ),
        migrations.AddField(
            model_name="playlist",
        ...
        migrations.AddField(
            ...
            name="media",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="ratings", to="files.media"
            ),
        ),
        migrations.AddField(
            model_name="rating",
        ...
        migrations.AddField(
            ...
            name="media",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="subtitles", to="files.media"
            ),
        ),
        migrations.AddField(
            model_name="subtitle",
        ...
        migrations.AddField(
            ...
            name="tags",
            field=models.ManyToManyField(
                blank=True, help_text="select one or more out of the existing tags", to="files.tag"
            ),
        ),
        migrations.AddField(
            model_name="media",
        ...
        migrations.AddField(
            ...
            name="media",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="transcriptionrequests", to="files.media"
            ),
        ),
        migrations.AddIndex(
            model_name="rating",
        ...
        migrations.AddIndex(
            model_name="media",
            index=models.Index(
                fields=["state", "encoding_status", "is_reviewed", "title"], name="files_media_state_43e940_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="media",
            index=models.Index(
                fields=["state", "encoding_status", "is_reviewed", "user"], name="files_media_state_1e0540_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="media",
