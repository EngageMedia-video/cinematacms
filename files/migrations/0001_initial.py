    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('popup', models.FileField(help_text='3:4 aspect ratio preferred. WebP under 200 KB recommended (JPEG/PNG accepted). Auto-resized to 540px width.', max_length=500, upload_to='homepage-popups/', verbose_name='popup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(blank=True, help_text='Description text. HTML links allowed for internal URLs only (e.g., /about, /blog-post)', null=True, validators=[users.validators.validate_internal_html])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(help_text='language code', max_length=100, unique=True)),
                ('title', models.CharField(help_text='language title', max_length=100)),
            ],
            options={
                'ordering': ['title'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_language', models.CharField(blank=True, db_index=True, default='en', max_length=35, null=True)),
                ...
                ('state', models.CharField(choices=[('private', 'Private'), ('public', 'Public'), ('restricted', 'Restricted'), ('unlisted', 'Unlisted')], db_index=True, default='private_verified', max_length=20)),
