    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "listings_thumbnail",
                    models.CharField(blank=True, help_text="Thumbnail to show on listings", max_length=400, null=True),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "extension",
                    models.CharField(choices=[("mp4", "mp4"), ("webm", "webm"), ("gif", "gif")], max_length=10),
                ),
                (
                    "resolution",
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.TextField(
                        blank=True, help_text="This will not appear on the pop-up", verbose_name="Pop-up name"
                    ),
                ),
                (
                    "popup",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("Yes", "Yes"), ("No", "No"), ("Partially", "Partially")],
                        max_length=10,
                        null=True,
                    ),
                ),
                ...
                (
                    "thumbnail_path",
                    models.CharField(blank=True, max_length=200, null=True, verbose_name="Path for thumbnail"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail_time",
                    models.FloatField(
                        blank=True, help_text="Time on video file that a thumbnail will be taken", null=True
                    ),
                ),
                (
                    "sprites",
                    models.FileField(blank=True, max_length=500, upload_to=files.models.original_thumbnail_file_path),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("video", "Video"), ("image", "Image"), ("pdf", "Pdf"), ("audio", "Audio")],
                        db_index=True,
                        default="video",
                        max_length=20,
                    ),
                ...
                (
                    "password",
                    models.CharField(blank=True, help_text="when video is in restricted state", max_length=100),
                ),
                (
                    "enable_comments",
                    models.BooleanField(default=True, help_text="Whether comments will be allowed for this media"),
                ),
                ...
                (
                    "allow_download",
                    models.BooleanField(default=True, help_text="Whether the  original media file can be downloaded"),
                ),
                ("year_produced", models.IntegerField(blank=True, help_text="Year media was produced", null=True)),
                (
                    "allow_whisper_transcribe",
                    models.BooleanField(default=False, verbose_name="Transcribe auto-detected language"),
                ),
                (
                    "allow_whisper_transcribe_and_translate",
                    models.BooleanField(default=False, verbose_name="Translate to English"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail",
                    imagekit.models.fields.ProcessedImageField(blank=True, upload_to=files.models.topic_thumb_path),
                ),
            ],
            options={
                "ordering": ["title"],
