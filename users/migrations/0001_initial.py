    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.CharField(
                        db_index=True, help_text="email that will be blacklisted", max_length=90, unique=True
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_added",
                    models.DateTimeField(db_index=True, default=django.utils.timezone.now, verbose_name="date added"),
                ),
                ...
                (
                    ...
                    models.BooleanField(default=True, verbose_name="Notify me about comments on my content"),
                ),
                ...
                (
                    "social_media_links",
                    models.TextField(
                        blank=True, help_text="Comma separated list of URLs", verbose_name="Social Media links"
                    ),
                ),
                ...
                (
                    "allow_contact",
                    models.BooleanField(
                        default=True, verbose_name="Whether allow contact will be shown on profile page"
                    ),
                ),
                (
                    "last_published_video_datetime",
                    models.DateTimeField(
                        db_index=True, default="2008-1-1", verbose_name="datetime of the last video that was published"
                    ),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "banner_logo",
                    imagekit.models.fields.ProcessedImageField(
                        blank=True, default="userlogos/banner.jpg", upload_to="userlogos/%Y/%m/%d"
                    ),
                ),
                (
                    "subscribers",
                    models.ManyToManyField(blank=True, related_name="subscriptions", to=settings.AUTH_USER_MODEL),
                ),
                (
                    "user",
                    models.ForeignKey(
