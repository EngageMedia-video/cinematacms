...
```
1. Frontend: pages/UploadPage.js (Django template)
...
**A simple walkthrough to make your first code change and pull request.**

This tutorial will walk you through a small, safe change to help you learn the contribution workflow.

#### Goal: Change the Portal Name

We'll change the portal name from "CinemataCMS" to something custom - a perfect first contribution!

**Step 1: Set up your development environment**

Make sure you've completed the [Installation Steps](#installation-steps) and can access http://127.0.0.1:8000.

**Step 2: Fork and clone** (if you haven't already)
...
git checkout -b feature/update-portal-name
```

**Step 4: Make the change**

Edit the portal name in your local settings:

```bash
# Open cms/local_settings.py in your editor
nano cms/local_settings.py
# or: code cms/local_settings.py
```
...
Change it to:
```python
PORTAL_NAME='My Custom Portal'  # Or any name you prefer!
```
...
```bash
# Restart the Django development server (Ctrl+C to stop, then:)
make dev-server

# Visit http://127.0.0.1:8000
# You should see your new portal name in the header/title!
```
...
# Check what changed
git status
git diff cms/local_settings.py

# Stage the change
git add cms/local_settings.py

# Commit with a descriptive message
git commit -m "Update portal name to 'My Custom Portal'

This is my first contribution to CinemataCMS! I've changed
the portal name to personalize my local installation."

# Push to your fork
git push origin feature/update-portal-name
```

**Step 7: Create a pull request**

1. Go to your fork on GitHub: `https://github.com/YOUR_USERNAME/cinematacms`
2. You'll see a banner: "feature/update-portal-name had recent pushes"
3. Click **"Compare & pull request"**
4. Fill in the PR details:
   - **Title**: "Update portal name (first contribution)"
   - **Description**:
     ```markdown
     ## Summary
     - Updated portal name in local_settings.py for testing
     - This is my first contribution to learn the workflow!

     ## Test Plan
     - [ ] Restarted dev server
     - [ ] Verified portal name appears correctly
...
# Add and commit
git add cms/local_settings.py
git commit -m "Address review feedback: use consistent formatting"
...
Once your PR is approved and merged, you're officially a CinemataCMS contributor!

#### What You Learned

- ✅ How to fork and clone the repository
- ✅ How to create a feature branch
- ✅ How to make and test a code change
- ✅ How to commit with descriptive messages
- ✅ How to push changes to your fork
- ✅ How to create a pull request
- ✅ How to address review feedback

#### Next Steps for Real Contributions

Now that you understand the workflow, you can tackle real issues:

1. **Find an issue:**
   - Look for issues tagged `good first issue` or `beginner-friendly`
   - Browse [open issues](https://github.com/EngageMedia-video/cinematacms/issues)

2. **Before starting:**
   - Comment on the issue saying you'd like to work on it
   - Wait for confirmation from a maintainer
   - Discuss your approach if it's complex
...
4. **Write good commit messages:**
   ...
   git commit -m "Fix media upload validation for large files

   - Added file size check before processing
   - Return clear error message to user
   - Added test case for files > 5GB
...
5. **Keep your branch updated:**
   ```bash
   # Before creating PR, rebase onto latest main
   git fetch upstream
