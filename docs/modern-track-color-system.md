...
| `bg/impact-modal-close`, `bg/impact-modal-field`, `bg/impact-modal-submit`, `bg/impact-modal-submit-hover`, `bg/impact-modal-surface`, `bg/impact-timeline-dot` | 6 | Community Impact modal controls, Add Impact form surfaces, submit CTA, and timeline dot. |
...
| `text/link`, `text/link-hover`, `text/accent`, `text/impact-icon-saves`, `text/impact-modal-close`, `text/impact-modal-heading`, `text/impact-modal-label`, `text/impact-modal-placeholder`, `text/impact-modal-subtitle`, `text/impact-modal-value`, `text/danger`, `text/success`, `text/warning` | 13 | Inline-link, Community Impact modal/icon text, and semantic text. Link tokens use darker sunset-horizon steps in light theme for AA contrast on white and raised tinted surfaces. |
| `border/default`, `border/subtle`, `border/divider`, `border/scrollbar`, `border/strong`, `border/strong-constant`, `border/chrome`, `border/impact-modal-field`, `border/input`, `border/danger` | 10 | Card borders, section dividers, scrollbar thumbs, hairlines, Add Impact modal fields, input borders, and subtle checkbox fills via `bg-border-subtle`. |
