		...
		>
			...
			<div className="col-start-1 flex min-w-0 gap-3 @2xl:contents">
				...
				<div className="flex min-w-0 flex-1 flex-col gap-3">
					<a
						href={mediaUrl}
						className="line-clamp-3 break-words text-text-strong no-underline hover:text-text-link-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-ring-focus body-body-16-medium"
					>
						{title}
					</a>
