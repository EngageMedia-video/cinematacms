	...
	return (
		<>
			...
			>
				...
				{void 0 === props.viewAllLink || null === props.viewAllLink ? null : (
					<a
						href={props.viewAllLink}
						title={props.viewAllText || props.viewAllLink}
						className="hw-category-link"
					>
						{props.viewAllText || props.viewAllLink}
					</a>
				)}
			</div>
			{props.desc && (
				<div className="hw-category-description" dangerouslySetInnerHTML={{ __html: props.desc }}></div>
			)}
		</>
	);
}
