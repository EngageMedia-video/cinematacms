...
// Converted from UMD to ESM — the original UMD's CJS branch conflicts with
// Rollup's module wrapper, causing `require is not defined` at runtime.
...
(function (_video) {
	...
	var defaultSetting = {
		...
		breakOverlay: {
			...
			style: {
				width: '100%',
				height: '20%',
				'background-color': 'var(--cinemata-neutral-600)',
				color: 'white',
				'font-size': '17px',
			},
		},
	...
	function registerVideoJsMarkersPlugin(options) {
		...
		function createMarkerDiv(marker) {
			var markerDiv = _video2.default.createEl(
				'div',
				{},
				{
