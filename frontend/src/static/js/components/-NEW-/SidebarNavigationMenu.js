...
export function SidebarNavigationMenu() {
	...
	function MainMenuFirstSection() {
		...
		if (
			PageStore.get('config-enabled').taxonomies.topics &&
			PageStore.get('config-enabled').taxonomies.topics.enabled
		) {
			items.push({
		...
		if (
			PageStore.get('config-enabled').taxonomies.languages &&
			PageStore.get('config-enabled').taxonomies.languages.enabled
		) {
			items.push({
		...
		if (
			PageStore.get('config-enabled').taxonomies.countries &&
			PageStore.get('config-enabled').taxonomies.countries.enabled
		) {
			items.push({
