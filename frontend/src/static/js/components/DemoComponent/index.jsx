	...
	return (
		<div className="demo-component">
			...
			<div className="demo-component__counter">
				<button className="demo-component__button" onClick={handleDecrement} disabled={count === 0}>
					-
				</button>
				<span className="demo-component__count">{count}</span>
				<button className="demo-component__button" onClick={handleIncrement} disabled={count === 10}>
					+
				</button>
			</div>
			<button className="demo-component__reset" onClick={handleReset}>
				Reset
			</button>
		</div>
	);
