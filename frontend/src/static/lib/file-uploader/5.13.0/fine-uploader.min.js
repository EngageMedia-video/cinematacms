		...
		return {
			...
			hasAttribute: function (t) {
				...
				return e.hasAttribute
					? !!e.hasAttribute(t) && null == /^false$/i.exec(e.getAttribute(t))
					: ((n = e[t]), void 0 !== n && null == /^false$/i.exec(n));
			},
		};
	};
	!(function () {
		...
		(qq.canvasToBlob = function (e, t, n) {
			...
			(qq.dataUriToBlob = function (e) {
				...
				return (
					(n = e.split(',')[0].indexOf('base64') >= 0 ? atob(e.split(',')[1]) : decodeURI(e.split(',')[1])),
			...
			(qq.isInput = function (e, t) {
				...
				return (
					!!(
						...
						'[object HTMLInputElement]' === Object.prototype.toString.call(e) &&
						e.type &&
						n(e.type)
			...
			(qq.isFileChunkingSupported = function () {
				return (
					...
					(void 0 !== File.prototype.slice ||
						void 0 !== File.prototype.webkitSlice ||
						void 0 !== File.prototype.mozSlice)
				);
			}),
			...
			(qq.each = function (e, t) {
				...
				if (e)
					...
					else if (qq.isString(e)) for (n = 0; n < e.length && ((i = t(n, e.charAt(n))), i !== !1); n++);
					else
						for (n in e)
			...
			(qq.obj2url = function (e, t, n) {
				...
				return (
					...
					t ? i.join(o) : i.join(o).replace(/^&/, '').replace(/%20/g, '+')
				);
			}),
			...
			(qq.obj2Inputs = function (e, t) {
				var n;
				return (
					t || (t = document.createElement('form')),
					qq.obj2FormData(e, {
						append: function (e, i) {
		...
		(qq.supportedFeatures = (function () {
			...
			function t() {
				return (
					(qq.chrome() || qq.opera()) &&
					void 0 !== navigator.userAgent.match(/Chrome\/[2][1-9]|Chrome\/[3-9][0-9]/)
				);
			}
			function n() {
				return (
					(qq.chrome() || qq.opera()) &&
					void 0 !== navigator.userAgent.match(/Chrome\/[1][4-9]|Chrome\/[2-9][0-9]/)
				);
			}
			function i() {
			...
			var u, c, d, p, h, q, f, m, g, _, v, b, y, S, w;
			return (
				(u = e()),
				(p = u && qq.isXhrUploadSupported()),
				(c = p && !qq.androidStock()),
				(d = p && l()),
				(h = d && t()),
				(q = p && qq.isFileChunkingSupported()),
				(f = p && q && s()),
				(m = p && n()),
				(g = u && (void 0 !== window.postMessage || p)),
				(v = i()),
				(_ = o()),
				(b = r()),
				(y = a()),
				(S = p && void 0 !== window.FileReader),
				(w = (function () {
		...
		(qq.UploadButton = function (e) {
			...
			function t() {
				var e = document.createElement('input');
				return (
					e.setAttribute(qq.UploadButton.BUTTON_ID_ATTR_NAME, i),
					e.setAttribute('title', a.title),
					o.setMultiple(a.multiple, e),
					a.folders && qq.supportedFeatures.folderSelection && e.setAttribute('webkitdirectory', ''),
					a.acceptFiles && e.setAttribute('accept', a.acceptFiles),
					...
					!qq.ie7() && qq(e).css({ height: '100%' }),
					a.element.appendChild(e),
					r.attach(e, 'change', function () {
						a.onChange(e);
					}),
			...
			qq.extend(a, e),
				(i = qq.getUniqueId()),
				qq(a.element).css({ position: 'relative', overflow: 'hidden', direction: 'ltr' }),
				qq.extend(this, {
					getInput: function () {
						return n;
					},
		...
		(qq.UploadData = function (e) {
			...
			qq.extend(this, {
				addFile: function (t) {
					...
					return (
						t.batchId &&
							((o[i].batchId = t.batchId),
							void 0 === l[t.batchId] && (l[t.batchId] = []),
							l[t.batchId].push(i)),
						t.proxyGroupId &&
							((o[i].proxyGroupId = t.proxyGroupId),
							void 0 === s[t.proxyGroupId] && (s[t.proxyGroupId] = []),
							s[t.proxyGroupId].push(i)),
						(o[i].id = i),
						(r[t.uuid] = i),
						void 0 === a[n] && (a[n] = []),
						a[n].push(i),
						e.onStatusChange(i, null, n),
						i
					);
				},
				retrieve: function (e) {
		...
		(function () {
			...
			(qq.basePublicApi = {
				...
				addFiles: function (e, t, n) {
					...
					(this._currentBatchId = i),
						e &&
							...
							this.log('Received ' + d.length + ' files.'),
							this._prepareItemsForUpload(d, t, n));
				},
				cancel: function (e) {
				...
				continueUpload: function (e) {
					...
					return (
						!(!qq.supportedFeatures.pause || !this._options.chunking.enabled) &&
						(t.status === qq.status.PAUSED
							? (this.log(
									qq.format(
										'Paused file ID {} ({}) will be continued.  Not paused.',
										e,
										this.getName(e)
									)
								),
							...
							: (this.log(
									qq.format(
										'Ignoring continue for file ID {} ({}).  Not paused.',
										e,
										this.getName(e)
									),
									'error'
				...
				drawThumbnail: function (e, t, n, i, o) {
					...
					return (
						this._imageGenerator
							? ((r = this._thumbnailUrls[e]),
								(a = { customResizeFunction: o, maxSize: n > 0 ? n : null, scale: n > 0 }),
								!i && qq.supportedFeatures.imagePreviews && (r = this.getFile(e)),
								null == r
									? s.failure({ container: t, error: 'File or URL not found.' })
									: this._imageGenerator.generate(r, t, a).then(
											function (e) {
												s.success(e);
											},
											function (e, t) {
												s.failure({ container: e, error: t || 'Problem generating thumbnail' });
											}
										))
							: s.failure({ container: t, error: 'Missing image generator module' }),
						s
					);
				},
				...
				pauseUpload: function (e) {
					...
					if (qq.indexOf([qq.status.UPLOADING, qq.status.UPLOAD_RETRYING], t.status) >= 0) {
						...
						this.log(
							qq.format('Ignoring pause for file ID {} ({}).  Not in progress.', e, this.getName(e)),
							'error'
						);
					return !1;
				},
				...
				(qq.basePrivateApi = {
					_addCannedFile: function (e) {
						...
						return (
							e.deleteFileEndpoint && this.setDeleteFileEndpoint(e.deleteFileEndpoint, t),
							e.deleteFileParams && this.setDeleteFileParams(e.deleteFileParams, t),
							e.thumbnailUrl && (this._thumbnailUrls[t] = e.thumbnailUrl),
							this._netUploaded++,
					...
					_createUploadDataTracker: function () {
						...
						return new qq.UploadData({
							...
							onStatusChange: function (t, n, i) {
								e._onUploadStatusChange(t, n, i),
									e._options.callbacks.onStatusChange(t, n, i),
									e._maybeAllComplete(t, i),
									e._totalProgress &&
										setTimeout(function () {
					...
					_createUploadButton: function (e) {
						function t() {
							return (
								...
								!(
									i._options.workarounds.iosEmptyVideos &&
									qq.ios() &&
									!qq.ios6() &&
									i._isAllowedExtension(r, '.mov')
								) &&
								(void 0 === e.multiple ? i._options.multiple : e.multiple)
							);
						}
						var n,
							i = this,
					...
					_createUploadHandler: function (e, t) {
						var n = this,
							...
							o = {
								...
								onProgress: function (e, t, o, r) {
									o < 0 ||
										...
										(i[e]
											...
											: (n._onProgress(e, t, o, r), n._options.callbacks.onProgress(e, t, o, r)),
										(i[e] = { loaded: o, total: r }));
								},
								onComplete: function (e, t, o, r) {
									delete i[e];
									var a,
										s = n.getUploads({ id: e }).status;
									s !== qq.status.UPLOAD_SUCCESSFUL &&
										s !== qq.status.UPLOAD_FAILED &&
										((a = n._onComplete(e, t, o, r)),
										a instanceof qq.Promise
											? a.done(function () {
								...
								isQueued: function (e) {
									...
									return (
										t === qq.status.QUEUED ||
										t === qq.status.SUBMITTED ||
										t === qq.status.UPLOAD_RETRYING ||
										t === qq.status.PAUSED
									);
								},
						...
						return (
							qq.each(this._options.request, function (e, t) {
								o[e] = t;
							}),
							(o.customHeaders = this._customHeadersStore),
							e &&
								qq.each(e, function (e, t) {
									o[e] = t;
								}),
					...
					_formatSize: function (e) {
						...
						do (e /= 1e3), t++;
						while (e > 999);
						return Math.max(e, 0.1).toFixed(1) + this._options.text.sizeSymbols[t];
					},
					_generateExtraButtonSpecs: function () {
						var e = this;
						(this._extraButtonSpecs = {}),
							qq.each(this._options.extraButtons, function (t, n) {
								var i = n.multiple,
									o = qq.extend({}, e._options.validation, !0),
									r = qq.extend({}, n);
								void 0 === i && (i = e._options.multiple),
									r.validation && qq.extend(o, n.validation, !0),
									qq.extend(r, { multiple: i, validation: o }, !0),
									e._initExtraButton(r);
							});
					},
					...
					_getButtonId: function (e) {
						...
						if ((i instanceof qq.BlobProxy && (i = i.referenceBlob), i && !qq.isBlob(i))) {
							...
							if ('input' === i.tagName.toLowerCase() && 'file' === i.type.toLowerCase())
								return i.getAttribute(qq.UploadButton.BUTTON_ID_ATTR_NAME);
							if (
								((t = i.getElementsByTagName('input')),
								qq.each(t, function (e, t) {
					...
					_getValidationDescriptor: function (e) {
						return e.file instanceof qq.BlobProxy
							? { name: qq.getFilename(e.file.referenceBlob), size: e.file.referenceBlob.size }
							: { name: this.getUploads({ id: e.id }).name, size: this.getUploads({ id: e.id }).size };
					},
					...
					_handleCameraAccess: function () {
						if (this._options.camera.ios && qq.ios()) {
							var e = 'image/*;capture=camera',
								...
								i = this._options;
							n && n !== this._defaultButtonId && (i = this._extraButtonSpecs[n]),
								(i.multiple = !1),
								null === i.validation.acceptFiles
									? (i.validation.acceptFiles = e)
									: (i.validation.acceptFiles += ',' + e),
								qq.each(this._buttons, function (e, t) {
									if (t.getButtonId() === n)
										return t.setMultiple(i.multiple), t.setAcceptFiles(i.acceptFiles), !1;
								});
						}
					},
					_handleCheckedCallback: function (e) {
						var t = this,
							n = e.callback();
						return qq.isGenericPromise(n)
							? (this.log(
									e.name + ' - waiting for ' + e.name + ' promise to be fulfilled for ' + e.identifier
								),
								n.then(
									function (n) {
									...
									function () {
										e.onFailure
											? (t.log(e.name + ' promise failure for ' + e.identifier), e.onFailure())
											: t.log(e.name + ' promise failure for ' + e.identifier);
									}
								))
							: (n !== !1
									? e.onSuccess(n)
					...
					_handleNewFile: function (e, t, n) {
						var i = this,
							...
							a = qq.getFilename(e),
							s = e.blob || e,
							l = this._customNewFileHandler
								? this._customNewFileHandler
								: qq.bind(i._handleNewFileGeneric, i);
						!qq.isInput(s) && s.size >= 0 && (r = s.size),
							l(s, a, o, r, n, t, this._options.request.uuidName, {
					...
					_handlePasteSuccess: function (e, t) {
						var n = e.type.split('/')[1],
							i = t;
						null == i && (i = this._options.paste.defaultName),
							(i += '.' + n),
							this.addFiles({ name: i, blob: e });
					},
						...
						(this._formSupport =
							...
							this._formSupport && this._formSupport.attachedToForm
								? ((this._paramsStore = this._createStore(
									...
									this._formSupport.newEndpoint &&
										(this._options.request.endpoint = this._formSupport.newEndpoint))
								: (this._paramsStore = this._createStore(this._options.request.params));
					},
					_isDeletePossible: function () {
						return (
							!(!qq.DeleteFileAjaxRequester || !this._options.deleteFile.enabled) &&
					...
					_itemError: function (e, t, n) {
						...
						return (
							qq.each(d.allowedExtensions, function (e, t) {
								qq.isString(t) && s.push(t);
							}),
							(o = s.join(', ').toLowerCase()),
							i('{file}', this._options.formatFileName(u)),
							i('{extensions}', o),
							i('{sizeLimit}', this._formatSize(d.sizeLimit)),
							i('{minSizeLimit}', this._formatSize(d.minSizeLimit)),
							(r = a.match(/(\{\w+\})/g)),
							null !== r &&
								qq.each(r, function (e, t) {
									i(t, l[e]);
								}),
							this._options.callbacks.onError(null, u, a, void 0),
							a
						);
					},
					_manualRetry: function (e, t) {
						if (this._onBeforeManualRetry(e))
							return (
								this._netUploadedOrQueued++,
								this._uploadData.setStatus(e, qq.status.UPLOAD_RETRYING),
								t ? t(e) : this._handler.retry(e),
								!0
							);
					},
					_maybeAllComplete: function (e, t) {
						...
						t === qq.status.UPLOAD_SUCCESSFUL
							? this._succeededSinceLastAllComplete.push(e)
							: t === qq.status.UPLOAD_FAILED && this._failedSinceLastAllComplete.push(e),
							0 === i &&
					...
					_maybeHandleIos8SafariWorkaround: function () {
						...
						if (this._options.workarounds.ios8SafariUploads && qq.ios800() && qq.iosSafari())
							throw (
								...
								new qq.Error(this._options.messages.unsupportedBrowserIos8Safari))
							);
					},
					_maybeParseAndSendUploadError: function (e, t, n, i) {
						if (!n.success)
							if (i && 200 !== i.status && !n.error)
								this._options.callbacks.onError(e, t, 'XHR returned response code ' + i.status, i);
							else {
					...
					_maybeProcessNextItemAfterOnValidateCallback: function (e, t, n, i, o) {
						...
						if (t.length > n)
							...
							else if (!e) for (; n < t.length; n++) r._fileOrBlobRejected(t[n].id);
					},
					_onAllComplete: function (e, t) {
						this._totalProgress && this._totalProgress.onAllComplete(e, t, this._preventRetries),
							this._options.callbacks.onAllComplete(qq.extend([], e), qq.extend([], t)),
							(this._succeededSinceLastAllComplete = []),
							(this._failedSinceLastAllComplete = []);
					},
					_onAutoRetry: function (e, t, n, i, o) {
						var r = this;
						if (
							((r._preventRetries[e] = n[r._options.retry.preventRetryResponseProperty]),
							r._shouldAutoRetry(e, t, n))
						) {
							var a = 1e3 * r._options.retry.autoAttemptDelay;
							return (
								r._maybeParseAndSendUploadError.apply(r, arguments),
								r._options.callbacks.onAutoRetry(e, t, r._autoRetries[e]),
								r._onBeforeAutoRetry(e, t),
								r._uploadData.setStatus(e, qq.status.UPLOAD_RETRYING),
					...
					_onBeforeAutoRetry: function (e, t) {
						this.log(
							'Waiting ' + this._options.retry.autoAttemptDelay + ' seconds before retrying ' + t + '...'
						);
					},
					_onBeforeManualRetry: function (e) {
						...
						return this._preventRetries[e]
							...
							: this._handler.isValid(e)
								? ((t = this.getName(e)),
									this._options.callbacks.onManualRetry(e, t) !== !1 &&
					...
					_onCancel: function (e, t) {
						...
						!this._options.autoUpload && n >= 0 && this._storedIds.splice(n, 1),
							this._uploadData.setStatus(e, qq.status.CANCELED);
					},
					_onComplete: function (e, t, n, i) {
						return (
							n.success
								? (n.thumbnailUrl && (this._thumbnailUrls[e] = n.thumbnailUrl),
									this._netUploaded++,
									this._uploadData.setStatus(e, qq.status.UPLOAD_SUCCESSFUL))
								: (this._netUploadedOrQueued--,
									this._uploadData.setStatus(e, qq.status.UPLOAD_FAILED),
									n[this._options.retry.preventRetryResponseProperty] === !0 &&
										(this._preventRetries[e] = !0)),
					...
					_onDeleteComplete: function (e, t, n) {
						...
						n
							? (this._uploadData.setStatus(e, qq.status.DELETE_FAILED),
								this.log("Delete request for '" + i + "' has failed.", 'error'),
								void 0 === t.withCredentials
									? this._options.callbacks.onError(e, i, 'Delete request failed', t)
									: this._options.callbacks.onError(
											e,
											i,
											'Delete request failed with response code ' + t.status,
											t
										))
							: (this._netUploadedOrQueued--,
								this._netUploaded--,
								this._handler.expunge(e),
								this._uploadData.setStatus(e, qq.status.DELETED),
					...
					_onSubmitCallbackSuccess: function (e, t) {
						this._onSubmit.apply(this, arguments),
							this._uploadData.setStatus(e, qq.status.SUBMITTED),
					...
					_onValidateBatchCallbackSuccess: function (e, t, n, i, o) {
						...
						0 === a || s <= a
							...
							: (this._onValidateBatchCallbackFailure(t),
								(r = this._options.messages.tooManyItemsError
									.replace(/\{netItems\}/g, s)
									.replace(/\{itemLimit\}/g, a)),
								this._batchError(r));
					},
					_onValidateCallbackFailure: function (e, t, n, i) {
						var o = t + 1;
						this._fileOrBlobRejected(e[t].id, e[t].file.name),
							this._maybeProcessNextItemAfterOnValidateCallback(!1, e, o, n, i);
					},
					_onValidateCallbackSuccess: function (e, t, n, i) {
						var o = this,
							r = t + 1,
							a = this._getValidationDescriptor(e[t]);
						this._validateFileOrBlobData(e[t], a).then(
							function () {
								o._upload(e[t].id, n, i),
									o._maybeProcessNextItemAfterOnValidateCallback(!0, e, r, n, i);
							},
							function () {
					...
					_refreshSessionData: function () {
						...
						qq.Session &&
							null != this._options.session.endpoint &&
							(this._session ||
								(qq.extend(t, { cors: this._options.cors }),
								(t.log = qq.bind(this.log, this)),
								(t.addFileRecord = qq.bind(this._addCannedFile, this)),
								(this._session = new qq.Session(t))),
							setTimeout(function () {
								e._session.refresh().then(
									function (t, n) {
					...
					_shouldAutoRetry: function (e, t, n) {
						...
						return (
							!!(
								!this._preventRetries[e] &&
								this._options.retry.enableAuto &&
								i.status !== qq.status.PAUSED &&
								(void 0 === this._autoRetries[e] && (this._autoRetries[e] = 0),
								this._autoRetries[e] < this._options.retry.maxAutoAttempts)
					...
					_trackButton: function (e) {
						...
						(t = qq.supportedFeatures.ajaxUploading
							...
							: this._getButtonId(this._handler.getInput(e))),
							t && (this._buttonIdsForFileIds[e] = t);
					},
					_updateFormSupportAndParams: function (e) {
						(this._options.form.element = e),
							(this._formSupport =
								qq.FormSupport &&
								new qq.FormSupport(
									this._options.form,
							...
							this._formSupport &&
								...
								(this._options.autoUpload = this._formSupport.newAutoUpload),
								this._formSupport.newEndpoint && this.setEndpoint(this._formSupport.newEndpoint));
					},
					_upload: function (e, t, n) {
						var i = this.getName(e);
						t && this.setParams(t, e),
							n && this.setEndpoint(n, e),
							this._handleCheckedCallback({
								name: 'onSubmit',
					...
					_uploadStoredFiles: function () {
						...
						(t = this.getUploads({ status: qq.status.SUBMITTING }).length),
							t &&
								(qq.log(
									'Still waiting for ' +
										t +
					...
					_validateFileOrBlobData: function (e, t) {
						...
						return (
							...
							qq.isFileOrInput(i) && !this._isAllowedExtension(s.allowedExtensions, o)
								? (this._itemError('typeError', o, i), l.failure())
								: this._options.validation.allowEmpty || 0 !== r
									? r > 0 && s.sizeLimit && r > s.sizeLimit
										? (this._itemError('sizeError', o, i), l.failure())
										: r > 0 && r < s.minSizeLimit
											? (this._itemError('minSizeError', o, i), l.failure())
											: (qq.ImageValidation && qq.supportedFeatures.imagePreviews && qq.isFile(i)
													? new qq.ImageValidation(i, qq.bind(n.log, n))
															.validate(s.image)
															.then(l.success, function (e) {
																n._itemError(e + 'ImageError', o, i), l.failure();
															})
													: l.success(),
												l)
									: (this._itemError('emptyError', o, i), l.failure())
						);
					},
					_wrapCallbacks: function () {
						...
						for (n in this._options.callbacks)
							!(function () {
								var i, o;
								(i = n),
									(o = e._options.callbacks[i]),
									(e._options.callbacks[i] = function () {
		...
		(function () {
			...
			(qq.FineUploaderBasic = function (e) {
				...
				(this._options = {
					...
					this._scaler.enabled &&
						(this._customNewFileHandler = qq.bind(this._scaler.handleNewFile, this._scaler)),
					qq.TotalProgress &&
						qq.supportedFeatures.progressBar &&
						(this._totalProgress = new qq.TotalProgress(qq.bind(this._onTotalProgress, this), function (e) {
		...
		(qq.AjaxRequester = function (e) {
			...
			function n(e) {
				var t = !1;
				return (
					qq.each(t, function (e, n) {
						if (qq.indexOf(['Accept', 'Accept-Language', 'Content-Language', 'Content-Type'], n) < 0)
							return (t = !0), !1;
					}),
					t
				);
			...
			function s(e, t) {
				...
				a(e),
					s
						? _(o + ' request for ' + e + ' has failed', 'error')
						: i(n) ||
							m(n.status) ||
							((s = !0), _(o + ' request for ' + e + ' has failed - response code ' + n.status, 'error')),
					S.onComplete(e, n, s);
			}
			function l(e) {
				var t,
					...
					i = S.mandatedParams;
				return (
					S.paramsStore.get && (t = S.paramsStore.get(e)),
					n &&
						qq.each(n, function (e, n) {
							(t = t || {}), (t[e] = n);
						}),
			...
			function u(e, t) {
				...
				return (
					S.onSend(e),
					(n = c(e, s, y[e].additionalQueryParams)),
					i(o) ? ((o.onload = h(e)), (o.onerror = q(e))) : (o.onreadystatechange = d(e)),
					p(e),
					o.open(a, n, !0),
					S.cors.expected && S.cors.sendCredentials && !i(o) && (o.withCredentials = !0),
					f(e),
					_('Sending ' + a + ' request for ' + e),
					u
						? o.send(u)
						: v || !s
							? o.send()
							: s &&
								  S.contentType &&
								  S.contentType.toLowerCase().indexOf('application/x-www-form-urlencoded') >= 0
								? o.send(qq.obj2url(s, ''))
								: s && S.contentType && S.contentType.toLowerCase().indexOf('application/json') >= 0
			...
			function p(e) {
				var t = S.onProgress;
				t &&
					(r(e).upload.onprogress = function (n) {
			...
			function f(e) {
				var o = r(e),
					...
					u = {};
				i(o) ||
					(S.acceptHeader && o.setRequestHeader('Accept', S.acceptHeader),
					S.allowXRequestedWithAndCacheControl &&
						((S.cors.expected && t() && !n(a)) ||
							(o.setRequestHeader('X-Requested-With', 'XMLHttpRequest'),
							o.setRequestHeader('Cache-Control', 'no-cache'))),
					!S.contentType ||
						('POST' !== l && 'PUT' !== l) ||
						o.setRequestHeader('Content-Type', S.contentType),
					qq.extend(u, qq.isFunction(a) ? a(e) : a),
					qq.extend(u, s),
					qq.each(u, function (e, t) {
			...
			if ((qq.extend(S, e), (_ = S.log), qq.indexOf(S.validMethods, S.method) < 0))
				throw new Error("'" + S.method + "' is not a supported method for this type of request!");
			(v = 'GET' === S.method || 'DELETE' === S.method),
				qq.extend(this, {
					initTransport: function (e) {
						...
						return {
							...
							send: function (s) {
								return (
									r &&
										qq.indexOf(['GET', 'DELETE'], S.method) >= 0 &&
										(n.qqtimestamp = new Date().getTime()),
									g(e, s, t, n, a, i, o)
								);
							},
						};
		...
		(qq.UploadHandlerController = function (e, t) {
			...
			var n,
				...
				u = {
						...
						(o._getFileState(e).attemptingResume = !1),
							delete o._getFileState(e).temp.chunkProgress[t],
							(o._getFileState(e).loaded += r.size),
							l.onUploadChunkSuccess(e, o._getChunkDataForCallback(r), n, i);
					},
					finalize: function (e) {
						var t = l.getSize(e),
							n = l.getName(e);
						i('All chunks have been uploaded for ' + e + ' - finalizing....'),
							o.finalizeChunks(e).then(
								function (r, a) {
								...
								function (t, o) {
									...
									i('Problem finalizing chunks for file ID ' + e + ' - ' + r.error, 'error'),
										r.reset && u.reset(e),
										l.onAutoRetry(e, n, r, o) || p.cleanup(e, r, o);
								}
							);
					},
					handleFailure: function (e, t, n, r) {
						...
						h.reset
							? u.reset(t)
							: ((d = qq.indexOf(o._getFileState(t).chunking.inProgress, e)),
								d >= 0 &&
									(o._getFileState(t).chunking.inProgress.splice(d, 1),
									o._getFileState(t).chunking.remaining.unshift(e))),
							o._getFileState(t).temp.ignoreFailure ||
								(s &&
									((o._getFileState(t).temp.ignoreFailure = !0),
									i(
										qq.format(
											'Going to attempt to abort these chunks: {}. These are currently in-progress: {}.',
											JSON.stringify(Object.keys(o._getXhrs(t))),
											JSON.stringify(o._getFileState(t).chunking.inProgress)
										)
									),
									qq.each(o._getXhrs(t), function (e, n) {
										i(
											qq.format(
									...
									o.moveInProgressToRemaining(t),
									c.free(t, !0)),
								l.onAutoRetry(t, a, h, r) || p.cleanup(t, h, r));
					},
					...
					reset: function (e) {
						i(
							...
							o._maybeDeletePersistedChunkData(e),
							o.reevaluateChunking(e),
							(o._getFileState(e).loaded = 0);
					},
					sendNext: function (e) {
						var t = l.getSize(e),
							n = l.getName(e),
						...
						null == o._getFileState(e).loaded && (o._getFileState(e).loaded = 0),
							d &&
								l.onResume(e, n, a) === !1 &&
								(u.reset(e), (r = u.nextPart(e)), (a = o._getChunkData(e, r)), (d = !1)),
							null == r && 0 === h.length
								? u.finalize(e)
								: (i(
										qq.format(
									...
									l.onUploadChunk(e, n, o._getChunkDataForCallback(a)),
									h.push(r),
									(o._getFileState(e).chunking.inProgress = h),
									s && c.open(e, r),
									s && c.available() && o._getFileState(e).chunking.remaining.length && u.sendNext(e),
									0 === a.blob.size
										? (i(
												qq.format(
													'Chunk {} for file {} will not be uploaded, zero sized chunk.',
													r,
													e
												),
												'error'
											),
											u.handleFailure(r, e, 'File is no longer available', null))
										: o
												.uploadChunk(e, r, d)
												.then(
													function (t, n) {
														i('Chunked upload request succeeded for ' + e + ', chunk ' + r),
															o.clearCachedChunk(e, r);
														var a = o._getFileState(e).chunking.inProgress || [],
															s = p.normalizeResponse(t, !0),
															l = qq.indexOf(a, r);
														i(
															qq.format(
																'Chunk {} for file {} uploaded successfully.',
																r,
																e
															)
														),
															u.done(e, r, s, n),
															l >= 0 && a.splice(l, 1),
															o._maybePersistChunkedState(e),
															u.hasMoreParts(e) || 0 !== a.length
																? u.hasMoreParts(e)
																	? u.sendNext(e)
																	: i(
																			qq.format(
				...
				c = {
					...
					available: function () {
						var e = l.maxConnections,
							...
							n = 0;
						return (
							qq.each(c._openChunks, function (e, i) {
								t++, (n += i.length);
							}),
					...
					free: function (e, t) {
						...
						delete c._openChunks[e],
							p.getProxyOrBlob(e) instanceof qq.BlobProxy &&
								(i('Generated blob upload has ended for ' + e + ', disposing generated blob.'),
								delete o._getFileState(e).file),
							a >= 0
								...
								: r &&
									...
									(c._open.splice(s, 1),
									(n = c._waiting.shift()),
									n >= 0 && (c._open.push(n), p.start(n)));
					},
					getWaitingOrConnected: function () {
						var e = [];
						return (
							qq.each(c._openChunks, function (t, n) {
					...
					open: function (e, t) {
						return (
							null == t && c._waiting.push(e),
							!!c.available() &&
								(null == t
									? (c._waiting.pop(), c._open.push(e))
									: !(function () {
				...
				d = {
					send: function (e, t) {
						(o._getFileState(e).loaded = 0),
							i('Sending simple upload request for ' + e),
							o.uploadFile(e).then(
								function (n, o) {
				...
				p = {
					...
					maybeDefer: function (e, t) {
						return t && !o.getFile(e) && t instanceof qq.BlobProxy
							? (l.onUploadPrep(e),
								i('Attempting to generate a blob on-demand for ' + e),
								t.create().then(
									function (t) {
										i('Generated an on-demand blob for ' + e),
											o.updateBlob(e, t),
											l.setSize(e, t.size),
											o.reevaluateChunking(e),
									...
									function (t) {
										...
										t && (o.error = t),
											...
											l.onComplete(e, l.getName(e), qq.extend(o, n), null),
											p.maybeSendDeferredFiles(e),
											c.free(e);
									}
								),
					...
					maybeSendDeferredFiles: function (e) {
						...
						return (
							t && t.length
								? (i('Maybe ready to upload proxy group file ' + e),
									qq.each(t, function (t, i) {
			...
			qq.extend(this, {
				...
				retry: function (e) {
					return (
						s && (o._getFileState(e).temp.ignoreFailure = !1),
						c.isUsingConnection(e) ? p.start(e) : r.upload(e)
					);
				},
				cancel: function (e) {
					var t = o.cancel(e);
					qq.isGenericPromise(t)
						? t.then(function () {
								p.cancel(e);
							})
						: t !== !1 && p.cancel(e);
				...
				pause: function (e) {
					return (
						!!(r.isResumable(e) && o.pause && r.isValid(e) && o.pause(e)) &&
						(c.free(e), o.moveInProgressToRemaining(e), !0)
					);
				},
				...
				qq.extend(l, e),
				(i = l.log),
				(a = l.chunking.enabled && qq.supportedFeatures.chunking),
				(s = a && l.chunking.concurrent.enabled),
				(n = (function () {
					var e = {};
			...
			qq.extend(t, e),
				qq.extend(this, {
					receiveMessage: function (e, t) {
						...
						window.postMessage
							? (n[e] = qq(window).attach('message', i))
		...
		(qq.FormUploadHandler = function (e) {
			...
			function o(e, t) {
				var i = e.id,
					...
					r = q(o);
				(u[r] = t),
					(c[o] = qq(e).attach('load', function () {
						a.getInput(o) &&
							(f('Received iframe load event for CORS upload request (iframe name ' + i + ')'),
					...
					m.receiveMessage(i, function (e) {
						...
						var t,
							...
							r = o.uuid;
						r && u[r]
							? (f('Handling response for iframe name ' + i),
								clearTimeout(d[i]),
								delete d[i],
								a._detachLoadEvent(i),
								(t = u[r]),
								delete u[r],
								m.stopReceivingMessages(i),
								t(o))
							: r || f("'" + e + "' does not contain a UUID - ignoring.");
					});
			}
			var r = e.options,
				a = this,
				...
				q = s.getUuid,
				f = s.log,
				m = new qq.WindowReceiveMessage({ log: f });
			qq.extend(this, new qq.UploadHandler(e)),
				qq.override(this, function (e) {
					return {
						add: function (t, n) {
							e.add(t, { input: n }), n.setAttribute('name', h), n.parentNode && qq(n).remove();
						},
						expunge: function (n) {
							t(n), e.expunge(n);
						},
				...
				qq.extend(this, {
					...
					_attachLoadEvent: function (e, t) {
						...
						p
							? o(e, t)
							: (c[e.id] = qq(e).attach('load', function () {
									if ((f('Received response for ' + e.id), e.parentNode)) {
										try {
											if (
												e.contentDocument &&
												e.contentDocument.body &&
												'false' == e.contentDocument.body.innerHTML
											)
												return;
										} catch (e) {
											f(
					...
					_initFormForUpload: function (e) {
						var t = e.method,
							...
							s = n;
						return (
							o ? qq.obj2Inputs(i, a) : (s = qq.obj2url(i, n)),
		...
		(qq.XhrUploadHandler = function (e) {
			...
			function t(e) {
				qq.each(n._getXhrs(e), function (t, i) {
					...
					(i.onreadystatechange = null),
						(i.upload.onprogress = null),
						i.abort(),
						o && o.canceled && o.canceled(e);
				});
			}
			var n = this,
			...
			qq.extend(this, new qq.UploadHandler(e)),
				qq.override(this, function (e) {
					return {
						add: function (t, i) {
							if (qq.isFile(i) || qq.isBlob(i)) e.add(t, { file: i });
							else {
				...
				qq.extend(this, {
					...
					getResumableFilesData: function () {
						var e = [];
						return (
							n._iterateResumeRecords(function (t, i) {
					...
					moveInProgressToRemaining: function (e, t, i) {
						...
						o &&
							(m(qq.format('Moving these chunks from in-progress {}, to remaining.', JSON.stringify(o))),
							o.reverse(),
							qq.each(o, function (e, t) {
								r.unshift(t);
							}),
							(o.length = 0));
					},
					pause: function (e) {
						if (n.isValid(e))
							return (
								m(qq.format("Aborting XHR upload for {} '{}' due to pause instruction.", e, u(e))),
								(n._getFileState(e).paused = !0),
								t(e),
								!0
							);
					},
					reevaluateChunking: function (e) {
						if (r && n.isValid(e)) {
							var t,
								...
								o = n._getFileState(e);
							if (
								(delete o.chunking, (o.chunking = {}), (t = n._getTotalChunks(e)), t > 1 || r.mandatory)
							) {
								for (
									o.chunking.enabled = !0, o.chunking.parts = t, o.chunking.remaining = [], i = 0;
									i < t;
									i++
								)
					...
					_getChunkData: function (e, t) {
						...
						return (d[t] = p), { part: t, start: s, end: l, count: u, blob: p, size: l - s };
					},
					...
					_iterateResumeRecords: function (e) {
						l &&
							qq.each(localStorage, function (t, n) {
					...
					_maybeDeletePersistedChunkData: function (e) {
						...
						return (
							!!(
								l &&
								n.isResumable(e) &&
								((t = n._getLocalStorageId(e)), t && localStorage.getItem(t))
					...
					_maybePrepareForResume: function (e) {
						...
						l &&
							void 0 === o.key &&
							((t = n._getLocalStorageId(e)),
							(i = localStorage.getItem(t)),
							i &&
								((i = JSON.parse(i)),
								h(i.uuid)
									? n._markNotResumable(e)
									: (m(qq.format('Identified file with ID {} and name of {} as resumable.', e, u(e))),
										q(e, i.uuid),
										(o.key = i.key),
										(o.chunking = i.chunking),
										(o.loaded = i.loaded),
										(o.attemptingResume = !0),
										n.moveInProgressToRemaining(e))));
					},
					_maybePersistChunkedState: function (e) {
						...
						if (l && n.isResumable(e)) {
							...
							try {
								...
								m(
									qq.format(
										"Unable to save resume data for '{}' due to error: '{}'.",
										e,
										t.toString()
									),
									'warn'
					...
					_registerXhr: function (e, t, i, o) {
						...
						return (
							(a.xhrs = a.xhrs || {}),
							(a.ajaxRequesters = a.ajaxRequesters || {}),
							(a.xhrs[r] = i),
							o && (a.ajaxRequesters[r] = o),
							i
						);
					},
			...
			qq.extend(i, e),
				...
				qq.extend(this, {
					sendDelete: function (e, t, o) {
						var r = o || {};
						i.log('Submitting delete file request for ' + e),
							'DELETE' === i.method
		...
		(function () {
			...
			function t(e, t, n) {
				...
				for (
					...
					(r = o[4 * (c - 1) + 3]), 0 === r ? (u = c) : (l = c), (c = (u + l) >> 1);
			...
			function n(e, t, n, i) {
				var r = document.createElement('canvas'),
					...
					s = new qq.Promise();
				return (
					o(e, t, r, n, i).then(function () {
						s.success(r.toDataURL(a, n.quality || 0.8));
					}),
					s
				);
			}
			...
			function o(n, o, s, l, u) {
				...
				return (
					...
					l.resize
						...
						: (qq.supportedFeatures.unlimitedScaledImageSize ||
								((c = i({ origWidth: h, origHeight: q })),
								c &&
									(qq.log(
										qq.format(
							...
							qq.ios()
								...
								: f.drawImage(n, 0, 0, h, q),
							s.qqImageRendered && s.qqImageRendered(),
							m.success(),
							m)
				);
			}
			function r(e) {
				...
				return (
					...
					(d.width = h),
					c.drawImage(n, 0, 0),
					l({ blob: t, height: p, image: n, sourceCanvas: u, targetCanvas: d, width: h }).then(function () {
			...
			function a(e, t, n, i) {
				...
				switch (i) {
					...
					case 6:
						...
						break;
					case 7:
						o.rotate(0.5 * Math.PI), o.translate(t, -n), o.scale(-1, 1);
						break;
					case 8:
						o.rotate(-0.5 * Math.PI), o.translate(-t, 0);
				}
			}
			function s(e, t) {
				var n = this;
			...
			(s.prototype.render = function (e, t) {
				...
				return this.imageLoadListeners
					? void this.imageLoadListeners.push(function () {
							r.render(e, t);
						})
					: (l && !u ? (u = ((s * l) / a) << 0) : u && !l ? (l = ((a * u) / s) << 0) : ((l = a), (u = s)),
						c && l > c && ((l = c), (u = ((s * l) / a) << 0)),
						d && u > d && ((u = d), (l = ((a * u) / s) << 0)),
						(i = { width: l, height: u }),
						qq.each(t, function (e, t) {
						...
						'img' === h
							...
							: 'canvas' === h && o(this.srcImage, this.blob, e, i, p),
						void ('function' == typeof this.onrender && this.onrender(e)));
			}),
				(qq.MegaPixImage = s);
		})(),
		(qq.ImageGenerator = function (e) {
			...
			function a(e) {
				...
				return (
					...
					(i = o.port),
					(n = o.hostname),
					t.toLowerCase() !== window.location.protocol.toLowerCase() ||
						n.toLowerCase() !== window.location.hostname.toLowerCase() ||
						(i !== window.location.port && !qq.ie())
				);
			}
			function s(t, n) {
				(t.onload = function () {
					...
					(t.onerror = function () {
						(t.onload = null),
							(t.onerror = null),
							e('Problem drawing thumbnail!', 'error'),
				...
				return (
					t(i)
						...
						: n(i)
							? l(i, o)
							: (o.failure(i),
								e(qq.format('Element container of type {} is not supported!', i.tagName), 'error')),
					r
				);
			}
			function c(t, n, i) {
				var o = new qq.Promise(),
					...
					l = function () {
						(n.onerror = null),
							(n.onload = null),
							e('Could not render preview, file may be too large!', 'error'),
							o.failure(n, 'Browser cannot render image!');
					};
				return (
					r.isPreviewable().then(
						function (r) {
							var c = {
									parse: function () {
			...
			function d(e, t, n, i, o) {
				var s = new Image(),
					l = new qq.Promise();
				u(s, l),
					a(e) && (s.crossOrigin = 'anonymous'),
					(s.src = e),
					l.then(function () {
						u(t, n);
						var a = new qq.MegaPixImage(s);
						a.render(t, { maxWidth: i, maxHeight: i, mime: r(e), resize: o });
					}, n.failure);
			}
			function p(e, t, n, i) {
				u(t, n), qq(t).css({ maxWidth: i + 'px', maxHeight: i + 'px' }), (t.src = e);
			}
			function h(e, r, s) {
			...
			qq.extend(this, {
				generate: function (t, n, i) {
					return qq.isString(t)
						? (e('Attempting to update thumbnail based on server response.'), h(t, n, i || {}))
						: (e('Attempting to draw client-side image preview.'), c(t, n, i || {}));
				},
			}),
				(this._testing = {}),
				(this._testing.isImg = t),
				(this._testing.isCanvas = n),
				(this._testing.isCrossOrigin = a),
				(this._testing.determineMimeOfFileName = r);
		}),
		(qq.Exif = function (e, t) {
			'use strict';
			function n(e) {
				for (var t = 0, n = 0; e.length > 0; )
					(t += parseInt(e.substring(0, 2), 16) * Math.pow(2, n)), (e = e.substring(2, e.length)), (n += 8);
				return t;
			}
			function i(t, n) {
				var o = t,
					r = n;
				return (
					void 0 === o && ((o = 2), (r = new qq.Promise())),
					qq.readBlobToHex(e, o, 4).then(function (e) {
						var t,
							n = /^ffe([0-9])/.exec(e);
						n
							? '1' !== n[1]
								? ((t = parseInt(e.slice(4, 8), 16)), i(o + t + 2, r))
								: r.success(o)
							: r.failure('No EXIF header to be found!');
					}),
					r
				);
			}
			function o() {
				...
				return (
					qq.readBlobToHex(e, 0, 6).then(function (e) {
						0 !== e.indexOf('ffd8')
							? t.failure('Not a valid JPEG!')
							: i().then(
									function (e) {
										t.success(e);
									},
			...
			function r(t) {
				...
				return (
					qq.readBlobToHex(e, t + 10, 2).then(function (e) {
						n.success('4949' === e);
					}),
					n
				);
			...
			function a(t, i) {
				var o = new qq.Promise();
				return (
					qq.readBlobToHex(e, t + 18, 2).then(function (e) {
			...
			var c = [274],
				d = { 274: { name: 'Orientation', bytes: 2 } };
			qq.extend(this, {
				parse: function () {
					var n = new qq.Promise(),
						i = function (e) {
						...
						o().then(function (o) {
							t(
								qq.format(
									...
									void 0 === e.name ? 'blob' : e.name
								)
							),
								r(o).then(function (e) {
									t(qq.format('EXIF Byte order is {} endian', e ? 'little' : 'big')),
										a(o, e).then(function (r) {
											t(qq.format('Found {} APP1 directory entries', r)),
												s(o, r).then(function (i) {
													var o = l(i),
														r = u(e, o);
				...
				(this._testing = {}),
				(this._testing.parseLittleEndian = n);
		}),
		(qq.Identify = function (e, t) {
			...
			qq.extend(this, {
				isPreviewable: function () {
					...
					return (
						t(qq.format('Attempting to determine if {} can be rendered in this browser', a)),
						t('First pass: check type attribute of blob object.'),
						this.isPreviewableSync()
							? (t('Second pass: check for magic bytes in file header.'),
								qq.readBlobToHex(e, 0, 4).then(
									function (e) {
										qq.each(i.PREVIEWABLE_MIME_TYPES, function (t, i) {
											if (n(i, e))
												return (
													('image/tiff' !== t || qq.supportedFeatures.tiffPreviews) &&
														((r = !0), o.success(t)),
													!1
												);
										}),
				...
				isPreviewableSync: function () {
					...
					return (
						i && (o = 'image/tiff' !== n || qq.supportedFeatures.tiffPreviews),
						!o && t(r + " is not previewable in this browser per the blob's type attr"),
						o
					);
				},
			});
		...
		(qq.ImageValidation = function (e, t) {
			...
			function i() {
				var n = new qq.Promise();
				return (
					new qq.Identify(e, t).isPreviewable().then(function () {
						var i = new Image(),
							o =
								window.URL && window.URL.createObjectURL
									? window.URL
						...
						o
							? ((i.onerror = function () {
									t('Cannot determine dimensions for image.  May be too large.', 'error'),
										n.failure();
								}),
								(i.onload = function () {
									n.success({ width: this.width, height: this.height });
								}),
								(i.src = o.createObjectURL(e)))
							: (t('No createObjectURL function available to generate image URL!', 'error'), n.failure());
					}, n.failure),
					n
				);
			}
			...
			this.validate = function (e) {
				...
				return (
					t('Attempting to validate image.'),
					n(e)
						? i().then(function (t) {
								var n = o(e, t);
						...
						qq.each(e, function (e, t) {
							if (null == t.uuid)
								(a = !0),
									i.log(
										qq.format(
											'Session response item {} did not include a valid UUID - ignoring.',
											e
										),
										'error'
									);
								...
								(a = !0),
									i.log(
										qq.format(
											'Session response item {} did not include a valid name - ignoring.',
											e
										),
										'error'
									);
			...
			qq.extend(i, e, !0),
				(this.refresh = function () {
					var e = new qq.Promise(),
						...
						o = qq.extend({}, i),
						r = new qq.SessionAjaxRequester(qq.extend(o, { onComplete: t }));
				...
				qq.extend(this, {
					queryServer: function () {
						...
						i.log('Session query request.'),
							n.initTransport('sessionRefresh').withParams(e).withCacheBuster().send();
					},
				});
		}),
			...
			qq.extend(this, {
				...
				getFileRecords: function (e, c, d) {
					var p = this,
						h = [],
						q = d.blob ? d.blob : d,
						f = new qq.Identify(q, t);
					return (
						f.isPreviewableSync()
							? (qq.each(u, function (e, i) {
									...
									h.push({
										uuid: qq.getUniqueId(),
										name: p._getName(c, { name: i.name, type: u, refType: q.type }),
										blob: new qq.BlobProxy(
											q,
											qq.bind(p._generateScaledImage, p, {
								...
								h.push({ uuid: e, name: c, size: q.size, blob: i ? q : null }))
							: h.push({ uuid: e, name: c, size: q.size, blob: q }),
						h
					);
				},
				handleNewFile: function (e, t, n, i, o, r, a, s) {
					...
					qq.each(l.getFileRecords(n, t, e), function (e, t) {
						var n,
							i = t.size;
						t.blob instanceof qq.BlobProxy && (i = -1),
							(n = p.addFile({ uuid: t.uuid, name: t.name, size: i, batchId: r, proxyGroupId: q })),
							t.blob instanceof qq.BlobProxy ? u.push(n) : (c = n),
							t.blob
								? (d(n, t.blob), o.push({ id: n, file: t.blob }))
								: p.setStatus(n, qq.status.REJECTED);
					}),
						null !== c &&
							(qq.each(u, function (e, t) {
								var n = {
									qqparentuuid: p.retrieve({ id: c }).uuid,
									qqparentsize: p.retrieve({ id: c }).size,
								};
								(n[a] = p.retrieve({ id: t }).uuid), p.setParentId(t, c), h.addReadOnly(t, n);
							}),
							u.length &&
								!(function () {
									var e = {};
									(e[a] = p.retrieve({ id: c }).uuid), h.addReadOnly(c, e);
								})());
				},
			});
		}),
		qq.extend(qq.Scaler.prototype, {
			scaleImage: function (e, t, n) {
				...
				var i = new qq.Promise(),
					...
					u = {
						...
						sizes: [{ name: '', maxSize: t.maxSize }],
					},
					c = new qq.Scaler(u, o);
				return (
					qq.Scaler && qq.supportedFeatures.imagePreviews && r
						? qq.bind(function () {
								var t = c.getFileRecords(l, s, r)[0];
								t && t.blob instanceof qq.BlobProxy
									? t.blob.create().then(i.success, i.failure)
									: (o(e + ' is not a scalable image!', 'error'), i.failure());
							}, this)()
						: (i.failure(),
							o(
			...
			_determineOutputType: function (e) {
				...
				var t = e.requestedType,
					...
					i = e.refType;
				return n || t
					? t && qq.indexOf(Object.keys(qq.Identify.prototype.PREVIEWABLE_MIME_TYPES), t) >= 0
						? 'image/tiff' === t
			...
			_getName: function (e, t) {
				...
				var n = e.lastIndexOf('.'),
					...
					s = '';
				return (
					t.name && t.name.trim().length && (s = ' (' + t.name + ')'),
					n >= 0 ? ((r = e.substr(0, n)), o !== i && (a = i.split('/')[1]), (r += s + '.' + a)) : (r = e + s),
					r
				);
			},
			...
			_generateScaledImage: function (e, t) {
				...
				return (
					o('Attempting to generate scaled version for ' + t.name),
					p.generate(t, h, { maxSize: r, orient: a, customResizeFunction: i }).then(
						function () {
							...
							c
								? n._insertExifHeader(t, e, o).then(
										function (t) {
											(e = t), i();
										},
										function () {
			...
			_insertExifHeader: function (e, t, n) {
				...
				return (
					...
					(i.onerror = function () {
						n(
							'Problem reading ' + e.name + ' during attempt to transfer EXIF data to scaled version.',
							'error'
						),
							o.failure();
					}),
		...
		(qq.ExifRestorer = (function () {
			var e = {};
			return (
				(e.KEY_STR = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/='),
				...
				(e.decode64 = function (e) {
					...
					if (c.exec(e))
						throw new Error(
							"There were invalid base64 characters in the input text.  Valid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='"
						);
		...
		(qq.PasteSupport = function (e) {
			...
			var o, r;
			(o = { targetElement: null, callbacks: { log: function (e, t) {}, pasteReceived: function (e) {} } }),
				qq.extend(o, e),
				n(),
				qq.extend(this, {
					reset: function () {
		...
		(qq.FormSupport = function (e, t, n) {
			...
			function o(e, t) {
				return (
					...
					(n('Form did not pass validation checks - will not upload.', 'error'), void t())
				);
			}
			function r(e) {
				var n = e.submit;
			...
			function a(e) {
				return (
					e &&
						(qq.isString(e) && (e = document.getElementById(e)),
						e && (n('Attaching to form element.'), i(e), l && r(e))),
					e
				);
			}
			var s = this,
			...
			_form2Obj: function (e) {
				...
				var t = {},
					...
					r = function (e) {
						var t = null;
						return (
							qq.each(qq(e).children(), function (e, n) {
				...
				return (
					qq.each(e.elements, function (e, i) {
		...
		(qq.traditional.FormUploadHandler = function (e, t) {
			'use strict';
			function n(e, t) {
				var n, i, r;
				try {
					(i = t.contentDocument || t.contentWindow.document),
						(r = i.body.innerHTML),
						s("converting iframe's innerHTML to JSON"),
						s('innerHTML = ' + r),
						r && r.match(/^<pre/i) && (r = i.body.firstChild.firstChild.nodeValue),
						(n = o._parseJsonResponse(r));
				} catch (e) {
					s('Error when attempting to parse form upload response (' + e.message + ')', 'error'),
						(n = { success: !1 });
				}
				return n;
			}
			...
			(this.uploadFile = function (t) {
				...
				return (
					(r = i(t, l)),
					r.appendChild(a),
					o._attachLoadEvent(l, function (i) {
						s('iframe loaded');
						var r = i ? i : n(t, l);
						o._detachLoadEvent(t),
							e.cors.expected || qq(l).remove(),
							r.success ? u.success(r) : u.failure(r);
					}),
					s('Sending upload request for ' + t),
					r.submit(),
					qq(r).remove(),
					u
				);
		...
		(qq.traditional = qq.traditional || {}),
		(qq.traditional.XhrUploadHandler = function (e, t) {
			'use strict';
			var n = this,
				i = t.getName,
				o = t.getSize,
				...
				l = function (t, n, r) {
					var a = o(t),
						l = i(t);
					(n[e.chunking.paramNames.partIndex] = r.part),
						(n[e.chunking.paramNames.partByteOffset] = r.start),
						(n[e.chunking.paramNames.chunkSize] = r.size),
						(n[e.chunking.paramNames.totalParts] = r.count),
						(n[e.totalFileSizeName] = a),
						s && (n[e.filenameParam] = l);
				},
				...
				d = function (t) {
					...
					return (
						(a[e.uuidName] = r(t)),
						(a[e.filenameParam] = s),
						(a[e.totalFileSizeName] = l),
						(a[e.chunking.paramNames.totalParts] = n._getTotalChunks(t)),
						a
					);
				},
				p = function (e, t) {
				...
				h = function (e, t) {
					var n;
					return (
						a('xhr - server response received for ' + e),
						a('responseText = ' + t.responseText),
						(n = q(!0, t)),
						{ success: !p(t, n), response: n }
					);
				},
				q = function (e, t) {
					var n = {};
				...
				f = function (t) {
					var i = new qq.Promise();
					return (
						u.complete(t, n._createXhr(t), d(t), e.customHeaders.get(t)).then(
							function (e) {
								i.success(q(!1, e), e);
							},
							function (e) {
				...
				m = function (t, n, a, l) {
					...
					return (
						(t[e.uuidName] = r(l)),
						(t[e.filenameParam] = p),
						s && (t[e.totalFileSizeName] = h),
						e.paramsInBody || (s || (t[e.inputName] = p), (d = qq.obj2url(t, d))),
						n.open(c, d, !0),
						e.cors.expected && e.cors.sendCredentials && (n.withCredentials = !0),
						s ? (e.paramsInBody && qq.obj2FormData(t, u), u.append(e.inputName, a), u) : a
					);
				},
				g = function (t, i) {
					...
					i.setRequestHeader('Accept', 'application/json'),
						...
						s ||
							...
							i.setRequestHeader('X-Mime-Type', r.type)),
						qq.each(o, function (e, t) {
			...
			qq.extend(this, {
				uploadChunk: function (t, i, r) {
					var a,
						s,
						u,
						d = n._getChunkData(t, i),
						p = n._createXhr(t, i);
					o(t);
					return (
						(a = c(t, p)),
						n._registerProgressHandler(t, i, d.size),
						(u = e.paramsStore.get(t)),
						l(t, u, d),
						r && (u[e.resume.paramNames.resuming] = !0),
						(s = m(u, p, d.blob, t)),
						g(t, p),
						p.send(s),
						a
				...
				uploadFile: function (t) {
					...
					return (
						(o = n._createXhr(t)),
						n._registerProgressHandler(t),
						(i = c(t, o)),
						(r = e.paramsStore.get(t)),
						(a = m(r, o, s, t)),
						g(t, o),
						o.send(a),
						i
				...
				qq.override(this, function (t) {
					return {
						finalizeChunks: function (n) {
							return e.chunking.success.endpoint ? f(n) : t.finalizeChunks(n, qq.bind(q, this, !0));
						},
					};
				});
		}),
		(qq.traditional.AllChunksDoneAjaxRequester = function (e) {
			...
			var t,
				n = 'POST',
				i = {
					cors: { allowXdr: !1, expected: !1, sendCredentials: !1 },
					endpoint: null,
					log: function (e, t) {},
				},
				o = {},
			...
			qq.extend(i, e),
				...
				qq.extend(this, {
					complete: function (e, n, r, a) {
						...
						return (
							i.log('Submitting All Chunks Done request for ' + e),
							(o[e] = s),
							t.initTransport(e).withParams(r).withHeaders(a).send(n),
							s
						);
					},
				});
		...
		(qq.DragAndDrop = function (e) {
			...
			function t(e, t) {
				...
				u.callbacks.dropLog('Grabbed ' + e.length + ' dropped files.'),
					t.dropDisabled(!1),
					u.callbacks.processingDroppedFilesComplete(n, t.getElement());
			}
			function n(e) {
				var t = new qq.Promise();
				return (
					e.isFile
						? e.file(
								...
								function (n) {
									u.callbacks.dropLog(
										"Problem parsing '" + e.fullPath + "'.  FileError code " + n.code + '.',
										'error'
									),
										t.failure();
								}
			...
			function o(e, t) {
				var i = [],
					o = new qq.Promise();
				return (
					u.callbacks.processingDroppedFiles(),
					t.dropDisabled(!0),
					e.files.length > 1 && !u.allowMultipleItems
						? (u.callbacks.processingDroppedFilesComplete([]),
							u.callbacks.dropError('tooManyFilesError', ''),
							t.dropDisabled(!1),
							o.failure())
						: ((h = []),
							qq.isFolderDropSupported(e)
								? qq.each(e.items, function (e, t) {
			...
			function r(e) {
				...
				return (
					q.addDisposer(function () {
						n.dispose();
					}),
					qq(e).hasAttribute(d) && qq(e).hide(),
					p.push(n),
					n
				);
			}
			...
			function l() {
				...
				qq.each(e, function (t, n) {
					...
					e.length &&
						...
						q.attach(document, 'dragenter', function (t) {
							!i.dropDisabled() &&
								a(t) &&
								qq.each(e, function (e, t) {
			...
			(u = {
				...
				qq.extend(this, {
					...
					removeDropzone: function (e) {
						var t,
							n = u.dropZoneElements;
						for (t in n) if (n[t] === e) return n.splice(t, 1);
					},
					dispose: function () {
						q.dispose(),
							qq.each(p, function (e, t) {
								t.dispose();
							});
					},
				});
		...
		(qq.UploadDropZone = function (e) {
			...
			function i(e) {
				...
				var t,
					...
					i = qq.safari();
				return (
					(t = !(!qq.ie() || !qq.supportedFeatures.fileDrop) || 'none' !== n.effectAllowed),
				...
				(qq.uiPrivateApi = {
					...
					_setupClickAndEditEventHandlers: function () {
						(this._fileButtonsClickHandler =
							qq.FileButtonsClickHandler && this._bindFileButtonsClickEvent()),
					...
					_filenameEditHandler: function () {
						...
						return {
							...
							onGetUploadStatus: function (t) {
								return e.getUploads({ id: t }).status;
							},
							onGetName: function (t) {
								return e.getName(t);
							},
							...
							onEditingStatusChange: function (e, n) {
								...
								n
									? (i.addClass('qq-editing'), t.hideFilename(e), t.hideEditIcon(e))
									: (i.removeClass('qq-editing'), t.showFilename(e), t.showEditIcon(e)),
									o.addClass('qq-temp').removeClass('qq-temp');
							},
						};
					},
					_onUploadStatusChange: function (e, t, n) {
						this._parent.prototype._onUploadStatusChange.apply(this, arguments),
							this._isEditFilenameEnabled() &&
								this._templating.getFileContainer(e) &&
								n !== qq.status.SUBMITTED &&
								(this._templating.markFilenameEditable(e), this._templating.hideEditIcon(e)),
							t === qq.status.UPLOAD_RETRYING && n === qq.status.UPLOADING
								? (this._templating.hideRetry(e),
									this._templating.setStatusText(e),
									qq(this._templating.getFileContainer(e)).removeClass(this._classes.retrying))
								: n === qq.status.UPLOAD_FAILED && this._templating.hidePause(e);
					},
					...
					_onSubmit: function (e, t) {
						...
						n &&
							n.qqPath &&
							this._options.dragAndDrop.reportDirectoryPaths &&
							this._paramsStore.addReadOnly(e, { qqpath: n.qqPath }),
							this._parent.prototype._onSubmit.apply(this, arguments),
							this._addToList(e, t);
					},
					_onSubmitted: function (e) {
						this._isEditFilenameEnabled() &&
							(this._templating.markFilenameEditable(e),
							this._templating.showEditIcon(e),
							this._focusinEventSupported ||
								this._filenameInputFocusHandler.addHandler(this._templating.getEditInput(e)));
					},
					_onProgress: function (e, t, n, i) {
						this._parent.prototype._onProgress.apply(this, arguments),
							this._templating.updateProgress(e, n, i),
							0 === i || 100 === Math.round((n / i) * 100)
								? (this._templating.hideCancel(e),
									this._templating.hidePause(e),
									this._templating.hideProgress(e),
									this._templating.setStatusText(e, this._options.text.waitingForResponse),
									this._displayFileSize(e))
								: this._displayFileSize(e, n, i);
					},
					_onTotalProgress: function (e, t) {
						this._parent.prototype._onTotalProgress.apply(this, arguments),
							this._templating.updateTotalProgress(e, t);
					},
					_onComplete: function (e, t, n, i) {
						function o(t) {
							s &&
								(a.setStatusText(e),
								qq(s).removeClass(l._classes.retrying),
								a.hideProgress(e),
								l.getUploads({ id: e }).status !== qq.status.UPLOAD_FAILED && a.hideCancel(e),
								a.hideSpinner(e),
								t.success
									? l._markFileAsSuccessful(e)
									: (qq(s).addClass(l._classes.fail),
										a.showCancel(e),
										a.isRetryPossible() &&
											!l._preventRetries[e] &&
											(qq(s).addClass(l._classes.retryable), a.showRetry(e)),
										l._controlFailureTextDisplay(e, t)));
						}
					...
					_markFileAsSuccessful: function (e) {
						...
						this._isDeletePossible() && t.showDeleteButton(e),
							qq(t.getFileContainer(e)).addClass(this._classes.success),
					...
					_onUploadChunk: function (e, t) {
						this._parent.prototype._onUploadChunk.apply(this, arguments),
							t.partIndex > 0 && this._handler.isResumable(e) && this._templating.allowPause(e);
					},
					_onCancel: function (e, t) {
						this._parent.prototype._onCancel.apply(this, arguments),
							this._removeFileItem(e),
					...
					_onBeforeAutoRetry: function (e) {
						...
						this._parent.prototype._onBeforeAutoRetry.apply(this, arguments),
							...
							this._options.retry.showAutoRetryNote &&
								((t = this._autoRetries[e]),
								(n = this._options.retry.maxAutoAttempts),
								(i = this._options.retry.autoRetryNote.replace(/\{retryNum\}/g, t)),
								(i = i.replace(/\{maxAuto\}/g, n)),
								this._templating.setStatusText(e, i),
								qq(this._templating.getFileContainer(e)).addClass(this._classes.retrying));
					},
					_onBeforeManualRetry: function (e) {
						return this._parent.prototype._onBeforeManualRetry.apply(this, arguments)
							? (this._templating.resetProgress(e),
								qq(this._templating.getFileContainer(e)).removeClass(this._classes.fail),
								this._templating.setStatusText(e),
								this._templating.showSpinner(e),
								this._showCancelLink(e),
								!0)
							: (qq(this._templating.getFileContainer(e)).addClass(this._classes.retryable),
								this._templating.showRetry(e),
								!1);
					},
					...
					_onDeleteComplete: function (e, t, n) {
						this._parent.prototype._onDeleteComplete.apply(this, arguments),
							this._templating.hideSpinner(e),
							n
								? (this._templating.setStatusText(e, this._options.deleteFile.deletingFailedText),
									this._templating.showDeleteButton(e))
								: this._removeFileItem(e);
					},
					_sendDeleteRequest: function (e, t, n) {
						this._templating.hideDeleteButton(e),
							this._templating.showSpinner(e),
							this._templating.setStatusText(e, this._options.deleteFile.deletingStatusText),
					...
					_showDeleteConfirm: function (e, t, n) {
						var i,
							...
							s = this;
						(i = this._options.showConfirm(r)),
							qq.isGenericPromise(i)
								? i.then(function () {
					...
					_addToList: function (e, t, n) {
						...
						this._options.display.prependFiles &&
							(this._totalFilesInBatch > 1 &&
								this._filesInBatchAddedToUi > 0 &&
								(r = this._filesInBatchAddedToUi - 1),
							(i = { index: r })),
							n ||
								...
								this._options.multiple ||
									((o = this.getUploads({ id: e })),
									(this._handledProxyGroup = this._handledProxyGroup || o.proxyGroupId),
									(o.proxyGroupId === this._handledProxyGroup && o.proxyGroupId) ||
										(this._handler.cancelAll(),
										this._clearList(),
										(this._handledProxyGroup = null)))),
							n
								? (this._templating.addFileToCache(e, this._options.formatFileName(t), i, a),
									this._templating.updateThumbnail(
										e,
										this._thumbnailUrls[e],
										!0,
										this._options.thumbnails.customResizer
									))
								: (this._templating.addFile(e, this._options.formatFileName(t), i, a),
									this._templating.generatePreview(
										e,
										this.getFile(e),
										this._options.thumbnails.customResizer
									)),
							(this._filesInBatchAddedToUi += 1),
							(n || (this._options.display.fileSizeOnSubmit && qq.supportedFeatures.ajaxUploading)) &&
								this._displayFileSize(e);
					},
					_clearList: function () {
					...
					_displayFileSize: function (e, t, n) {
						...
						i >= 0 &&
							(void 0 !== t && void 0 !== n && (o = this._formatProgress(t, n)),
							this._templating.updateSize(e, o));
					},
					...
					_controlFailureTextDisplay: function (e, t) {
						...
						(n = this._options.failedUploadTextDisplay.mode),
							...
							'custom' === n
								? ((o = t[i]),
									o || (o = this._options.text.failUpload),
									this._templating.setStatusText(e, o),
									this._options.failedUploadTextDisplay.enableTooltip && this._showTooltip(e, o))
								: 'default' === n
									? this._templating.setStatusText(e, this._options.text.failUpload)
									: 'none' !== n &&
										this.log(
											"failedUploadTextDisplay.mode value of '" + n + "' is not valid",
											'warn'
										);
					},
					...
					_showCancelLink: function (e) {
						(this._options.disableCancelForFormUploads && !qq.supportedFeatures.ajaxUploading) ||
							this._templating.showCancel(e);
					},
					_itemError: function (e, t, n) {
					...
					_prepareItemsForUpload: function (e, t, n) {
						(this._totalFilesInBatch = e.length),
							(this._filesInBatchAddedToUi = 0),
							this._parent.prototype._prepareItemsForUpload.apply(this, arguments);
					},
					_maybeUpdateThumbnail: function (e) {
						var t = this._thumbnailUrls[e],
							n = this.getUploads({ id: e }).status;
						n === qq.status.DELETED ||
							(!t &&
								!this._options.thumbnails.placeholders.waitUntilResponse &&
								qq.supportedFeatures.imagePreviews) ||
							this._templating.updateThumbnail(e, t, this._options.thumbnails.customResizer);
					},
					_addCannedFile: function (e) {
						var t = this._parent.prototype._addCannedFile.apply(this, arguments);
						return (
							this._addToList(t, this.getName(t), !0),
							this._templating.hideSpinner(t),
							this._templating.hideCancel(t),
							this._markFileAsSuccessful(t),
							t
						);
					},
					_setSize: function (e, t) {
						this._parent.prototype._setSize.apply(this, arguments),
							this._templating.updateSize(e, this._formatSize(t));
					},
					_sessionRequestComplete: function () {
		...
		(qq.FineUploader = function (e, t) {
			'use strict';
			var n = this;
			(this._parent = t ? qq[t].FineUploaderBasic : qq.FineUploaderBasic),
				...
				qq.extend(
					this._options,
					{
						...
						showMessage: function (e) {
							return n._templating.hasDialog('alert')
								? n._templating.showDialog('alert', e)
								: void setTimeout(function () {
										window.alert(e);
									}, 0);
						},
						showConfirm: function (e) {
							return n._templating.hasDialog('confirm')
								? n._templating.showDialog('confirm', e)
								: window.confirm(e);
						},
						showPrompt: function (e, t) {
							return n._templating.hasDialog('prompt')
								? n._templating.showDialog('prompt', e, t)
								: window.prompt(e, t);
						},
					},
					!0
		...
		(qq.Templating = function (e) {
			...
			var t,
				...
				f = 'qq-in-progress',
				m = 'qq-hidden-forever',
				g = { content: document.createDocumentFragment(), map: {} },
				_ = !1,
				v = 0,
				b = !1,
				y = [],
				...
				I = function () {
					...
					s &&
						(e
							? w.imageGenerator.generate(e, new Image(), i).then(
									function (e) {
										C.success(e);
									},
									function () {
										C.failure(),
											t("Problem loading 'not available' placeholder image at " + e, 'error');
									}
								)
							: C.failure(),
						n
							? w.imageGenerator.generate(n, new Image(), i).then(
									function (e) {
										E.success(e);
									},
									function () {
										E.failure(),
											t(
												"Problem loading 'waiting for thumbnail' placeholder image at " + n,
												'error'
											);
									}
								)
				...
				D = function (e, n, i) {
					var o = X(e);
					return (
						t('Generating new thumbnail for ' + e),
						(n.qqThumbnailId = e),
						w.imageGenerator.generate(n, o, i).then(
							function () {
								v++, te(o), x[e].success();
							},
							function () {
				...
				z = function (e) {
					return null == e
						? V(r, F.totalProgressBarContainer) || V(r, F.totalProgressBar)
						: V(L(e), F.progressBarContainer) || V(L(e), F.progressBar);
				},
				M = function (e) {
				...
				Q = function (e, t) {
					var n = e.style.maxWidth,
						i = e.style.maxHeight;
					i && n && !t.style.maxWidth && !t.style.maxHeight && qq(t).css({ maxWidth: n, maxHeight: i });
				},
				Y = function (e, t) {
				...
				J = function () {
					var e, o, r, a, u, c, f, m, g, _, v;
					if ((t('Parsing template'), null == w.templateIdOrEl))
						throw new Error('You MUST specify either a template element or ID!');
					if (qq.isString(w.templateIdOrEl)) {
						if (((e = document.getElementById(w.templateIdOrEl)), null === e))
							throw new Error(qq.format("Cannot find template script at ID '{}'!", w.templateIdOrEl));
						o = e.innerHTML;
					} else {
						if (void 0 === w.templateIdOrEl.innerHTML)
							throw new Error(
								'You have specified an invalid value for the template option!  It must be an ID or an Element.'
							);
					...
					if (
						...
						a.appendChild(qq.toElement(o)),
						(v = qq(a).getFirstByClass(F.uploader)),
						w.button && ((c = qq(a).getFirstByClass(F.button)), c && qq(c).remove()),
						(qq.DragAndDrop && qq.supportedFeatures.fileDrop) ||
							((g = qq(a).getFirstByClass(F.dropProcessing)), g && qq(g).remove()),
						(f = qq(a).getFirstByClass(F.drop)),
						f && !qq.DragAndDrop && (t('DnD module unavailable.', 'info'), qq(f).remove()),
						qq.supportedFeatures.fileDrop
							? qq(v).hasAttribute(q) &&
								f &&
								((_ = qq(f).getFirstByClass(F.dropText)), _ && qq(_).remove())
							: (v.removeAttribute(q), f && qq(f).hasAttribute(h) && qq(f).css({ display: 'none' })),
						(m = qq(a).getFirstByClass(F.thumbnail)),
						s
							? m &&
								((S = parseInt(m.getAttribute(d))), (S = S > 0 ? S : null), (l = qq(m).hasAttribute(p)))
							: m && qq(m).remove(),
						(s = s && m),
						(n = qq(a).getByClass(F.editFilenameInput).length > 0),
						(i = qq(a).getByClass(F.retry).length > 0),
						(r = qq(a).getFirstByClass(F.list)),
						null == r)
					)
					...
					return (
						(u = r.innerHTML),
						(r.innerHTML = ''),
						a.getElementsByTagName('DIALOG').length && document.createElement('dialog'),
						t('Template parsing complete'),
						{ template: qq.trimStr(a.innerHTML), fileTemplate: qq.trimStr(u) }
					);
				},
				Z = function (e, t, n) {
					var i = n,
				...
				K = function (e) {
					var t = e.id,
						...
						i = n && n.qqThumbnailId,
						o = X(t),
						r = { customResizeFunction: e.customResizeFunction, maxSize: S, orient: !0, scale: !0 };
					qq.supportedFeatures.imagePreviews
						? o
							? w.limits.maxThumbs && w.limits.maxThumbs <= v
								? (Y(t, o), T())
								: P(o).done(function () {
										(x[t] = new qq.Promise()),
											x[t].done(function () {
				...
				$ = function (e) {
					var t = e.id,
						...
						i = e.showWaitingImg,
						o = X(t),
						r = { customResizeFunction: e.customResizeFunction, scale: l, maxSize: S };
					if (o)
						if (n) {
							if (!(w.limits.maxThumbs && w.limits.maxThumbs <= v))
								return (
									i && P(o),
									w.imageGenerator.generate(n, o, r).then(
										function () {
				...
				ee = function (e, t) {
					...
					n && !qq(n).hasClass(i) && (n = qq(n).getFirstByClass(i)),
						n && (qq(n).css({ width: t + '%' }), n.setAttribute('aria-valuenow', t));
				},
				te = function (e) {
			...
			qq.extend(w, e),
				(t = w.log),
				qq.supportedFeatures.imagePreviews || ((w.limits.timeBetweenThumbs = 0), (w.limits.maxThumbs = 0)),
				(r = w.containerEl),
				(s = void 0 !== w.imageGenerator),
				(o = J()),
				I(),
				qq.extend(this, {
					render: function () {
						t('Rendering template in DOM.'),
							(v = 0),
							(r.innerHTML = o.template),
							W(B()),
							this.hideTotalProgress(),
							(a = w.fileContainerEl || V(r, F.list)),
							t('Template rendering complete');
					},
					...
					addFile: function (e, t, n, i, s) {
						...
						s && (g.map[e] = d),
							qq(d).addClass(c + e),
							h.removeAttribute(q),
							p && (qq(p).setText(t), p.setAttribute('title', t)),
							d.setAttribute(u, e),
							n ? Z(d, n.index, f) : f.appendChild(d),
							i
								? ((d.style.display = 'none'), qq(d).addClass(m))
								: (W(z(e)),
									W(j(e)),
									W(R(e)),
									W(M(e)),
					...
					hideSpinner: function (e) {
						qq(L(e)).removeClass(f), W(G(e));
					},
					showSpinner: function (e) {
						qq(L(e)).addClass(f), te(G(e));
					},
					generatePreview: function (e, t, n) {
						this.isHiddenForever(e) ||
							(y.push({ id: e, customResizeFunction: n, optFileOrBlob: t }), !b && T());
					},
					updateThumbnail: function (e, t, n, i) {
						this.isHiddenForever(e) ||
							(y.push({ customResizeFunction: i, update: !0, id: e, thumbnailUrl: t, showWaitingImg: n }),
							!b && T());
					},
		...
		(qq.UiEventHandler = function (e, t) {
			...
			var i = new qq.DisposeSupport(),
				o = { eventType: 'click', attachTo: null, onHandled: function (e, t) {} };
			qq.extend(this, {
		...
		(qq.FileButtonsClickHandler = function (e) {
			...
			function t(e, t) {
				qq.each(o, function (n, o) {
					...
					if (i.templating['is' + a](e))
						return (
							(r = i.templating.getFileId(e)),
							qq.preventDefault(t),
							i.log(
								qq.format(
			...
			qq.extend(i, e),
				(i.eventType = 'click'),
				(i.onHandled = t),
				(i.attachTo = i.templating.getFileList()),
				qq.extend(this, new qq.UiEventHandler(i, n));
		}),
		(qq.FilenameClickHandler = function (e) {
			...
			function t(e, t) {
				if (i.templating.isFileName(e) || i.templating.isEditIcon(e)) {
					...
					r === qq.status.SUBMITTED &&
						(i.log(
							qq.format("Detected valid filename click event on file '{}', ID: {}.", i.onGetName(o), o)
						),
						qq.preventDefault(t),
						n.handleFilenameEdit(o, e, !0));
				}
			}
			var n = {},
				i = {
					templating: null,
					log: function (e, t) {},
					classes: { file: 'qq-upload-file', editNameIcon: 'qq-edit-filename-icon' },
			...
			qq.extend(i, e),
				(i.eventType = 'click'),
				(i.onHandled = t),
				qq.extend(this, new qq.FilenameEditHandler(i, n));
		}),
		(qq.FilenameInputFocusInHandler = function (e, t) {
			...
			var i = { templating: null, onGetUploadStatus: function (e) {}, log: function (e, t) {} };
			t || (t = {}),
				(i.eventType = 'focusin'),
				(i.onHandled = n),
				qq.extend(i, e),
				qq.extend(this, new qq.FilenameEditHandler(i, t));
		}),
		...
		(qq.FilenameEditHandler = function (e, t) {
			...
			function o(e, t) {
				var n,
					o = e.value;
				void 0 !== o &&
					qq.trimStr(o).length > 0 &&
					((n = i(t)), void 0 !== n && (o = o + '.' + n), s.onSetName(t, o)),
					s.onEditingStatusChange(t, !1);
			}
			function r(e, n) {
			...
			qq.extend(s, e),
				(s.attachTo = s.templating.getFileList()),
				qq.extend(this, new qq.UiEventHandler(s, t)),
				qq.extend(t, {
